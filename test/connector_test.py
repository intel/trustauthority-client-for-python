...
class ConnectorTestCase(unittest.TestCase):
    ...
    def test_get_nonce(self):
        ...
        with patch('requests.get', url = "/appraisal/v1/nonce") as mock_get:
            ...
            assert nonce.nonce.val.replace('.','') == self.mocked_nonce["val"] and nonce.nonce.iat.replace('.','') == self.mocked_nonce["iat"] and nonce.nonce.signature == self.mocked_nonce["signature"]
    ...
    #             decoded_token = self.ita_c.verify_token(token)
    #             assert decoded_token == None
